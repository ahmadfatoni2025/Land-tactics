  ...
  return (
    <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-6">
      ...
      <div className="flex items-center gap-2 mb-2 px-1">
        <span className="text-[10px] font-black text-stone-400 uppercase tracking-[0.3em] italic">domain.com</span>
        <div className="h-1 w-1 rounded-full bg-stone-300"></div>
        <span className="text-[10px] font-black text-teal uppercase tracking-[0.3em] italic">dashboard</span>
      </div>
